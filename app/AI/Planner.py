...
CONVERSATION STATE (READ-ONLY): Use this to refer to prior messages from the user and assistant. Do not modify it.
...
The user may have uploaded images or files. A vision analysis system has examined them
and produced the following structured description.

Use this information when determining intent, tool usage, and response style.
